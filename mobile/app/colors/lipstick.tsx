...
export default function LipstickScreen() {
  return (
    <PaletteExplorer
      ...
      caveat={'VibeFit names colour families, not brand shades. A screen cannot predict how a particular product will oxidise on your lips, so treat these as the family to shop within and swatch the real thing on your hand.'}
      lookKind={'makeup'}
    />
  );
}
