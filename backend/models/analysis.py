...
class Analysis(Base):
    ...
    # Nullable since 0007: a user can delete the photograph and keep the
    # analysis. None means "there is no stored photograph any more", which is
    # a different thing from "there never was one" (a local:// placeholder).
