...
def generate_face_report(analysis: Any, user_name: str = "MyLookFit User") -> bytes:
    ...
    c.drawString(20 * mm, cur.y, "MyLookFit")
    ...
    c.drawString(20 * mm, 14 * mm,
                 "Generated by MyLookFit. Guidance only, not medical advice.")
