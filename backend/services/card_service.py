...
def card_fields(analysis: Any, user_name: str = "MyLookFit User") -> dict:
...
def generate_summary_card(analysis: Any, user_name: str = "MyLookFit User") -> bytes:
    ...
    d.text((80, 90), "MyLookFit", font=_font(72), fill=_GOLD)
    ...
    d.text((80, _SIZE - 70), "Generated by MyLookFit. Guidance only.",
